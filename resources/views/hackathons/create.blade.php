...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-end me-3 rotate-caret" id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="navbar-brand m-0" href="#" target="_blank">
      ...
      <span class="me-1 font-weight-bold">Hackathons</span>
    </a>
  </div>
  ...
  <div class="collapse navbar-collapse px-0 w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link active" href="{{ route('hackathon.index') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center ms-2 d-flex align-items-center justify-content-center">
          ...
          <span class="nav-link-text me-1">الهاكاثونات</span>
        </a>
          ...
          <a class="nav-link " href="../all-csv">
            ...
            <span class="nav-link-text me-1">كل المستخدمين</span>
          </a>
        </li>
        <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link" href="../pages/rtl.html">
          ...
          <span class="nav-link-text me-1">تجربة</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link " href="../pages/profile.html">
          ...
          <span class="nav-link-text me-1">حساب</span>
        </a>
      </li>
      <li class="nav-item">
...
<main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg overflow-hidden">
    ...
    <div class="container-fluid py-1 px-3">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 ">
          ...
          <li class="breadcrumb-item text-sm text-dark active" aria-current="page">الهاكاثونات</li>
        </ol>
        <h6 class="font-weight-bolder mb-0">الهاكاثونات</h6>
      </nav>
  ...
  <div class="container">
    <form action="{{route('hackathon.store')}}" method="post" enctype="multipart/form-data">
      @csrf
      <div class="form-group">
        <label for="name">اسم الهاكاثون</label>
        <input type="text" name="name" class="form-control" id="name" aria-describedby="" placeholder="اسم الهاكاثون">
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        <label for="targeted">الفئة المستهدفة</label>
        <input type="text" name="targeted" class="form-control" id="targeted" aria-describedby="" placeholder="الفئة المستهدفة">
      </div>
      <div class="form-group">
        <label for="teamsNum">اعضاء الفريق</label>
        <input type="text" name="teamsNum" class="form-control" id="teamsNum" aria-describedby="" placeholder="اعضاء الفريق">
      </div>
      <div class="form-group">
        <label for="hackathon_type">نوع المسابقة</label>
        <select class="form-control" name="hackathon_type" id="hackathon_type" placeholder="نوع المسابقة">
      ...
      {{-- <div class="form-group">
            <div><img height="100px" src="{{$hackathons->hackathon_image}}" alt="">
  </div>
  <label for="file">File</label>
  <input type="file" name="post_image" class="form-control-file" id="post_image">
  </div> --}}
  <div class="form-group">
    <textarea name="body" class="form-control" id="body" cols="30" rows="10" placeholder="تعليق"></textarea>
  </div>
      ...
      <div class="row align-items-center justify-content-lg-between">
        <div class="col-lg-6 mb-lg-0 mb-4">
          <div class="copyright text-center text-sm text-muted text-lg-end">
            ...
            صنع بكل <i class="fa fa-heart"></i> من قبل
            <a href="https://www.hackathonx.online" class="font-weight-bold" target="_blank">HackathonX</a>
            .
          </div>
        </div>
        <div class="col-lg-6">
          <ul class="nav nav-footer justify-content-center justify-content-lg-end">
            <li class="nav-item">
              <a href="https://www.creative-tim.com" class="nav-link text-muted" target="_blank">تجربة</a>
            </li>
            <li class="nav-item">
              <a href="https://www.creative-tim.com/presentation" class="nav-link text-muted" target="_blank">تجربة</a>
            </li>
            <li class="nav-item">
              <a href="https://creative-tim.com/blog" class="nav-link text-muted" target="_blank">تجربة</a>
            </li>
            <li class="nav-item">
              <a href="https://www.creative-tim.com/license" class="nav-link pe-0 text-muted" target="_blank">تجربة</a>
            </li>
          </ul>
        </div>
      </div>
