...
<div class="container">
    <form action="{{route('hackathon.update', $hackathons->id)}}" method="post" enctype="multipart/form-data">
        @csrf
        @method('PATCH')
        <div class="form-group">
            <label for="name">اسم الهاكاثون</label>
            <input type="text" name="name" class="form-control" id="name" aria-describedby="" placeholder="Enter title" value="{{$hackathons->name}}">
        </div>
        <div class="form-group">
            <label for="hackathon_image">صورة الهاكاثون</label>
            <i class="{{$hackathons->hackathon_image}}"></i>
            <input type="text" name="hackathon_image" class="form-control" id="hackathon_image" aria-describedby="" placeholder="Enter title" value="{{$hackathons->hackathon_image}}">
        </div>
        {{-- <div class="form-group">
        ...
        <div class="form-group">
            <textarea name="body" class="form-control" id="body" cols="30" rows="10">{{$hackathons->body}}</textarea>
        </div>
