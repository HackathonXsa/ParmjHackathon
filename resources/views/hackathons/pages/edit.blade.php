...
<div class="container">
    <form action="{{route('hackathon.page.update', $hackathons->hackathon_id)}}" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <label for="first_description">وصف الهاكاثون</label>
            <input type="text" name="first_description" class="form-control" id="first_description" aria-describedby="" placeholder="Enter first description" value="{{$hackathons->first_description}}">
        </div>
        <div class="form-group">
            <label for="second_description">الوصف الثاني للهاكاثون</label>
            <input type="text" name="second_description" class="form-control" id="second_description" aria-describedby="" placeholder="Enter second description" value="{{$hackathons->second_description}}">
        </div>
        {{-- <div class="form-group">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">إضافة مجال للهاكاثون</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <form action="{{ route('hackathons.fields.store') }}" method="post" enctype="multipart/form-data">
          @csrf
          <table class="table table-borderless" id="dynamicAddRemove">
            <tr>
                <th>المجال</th>
