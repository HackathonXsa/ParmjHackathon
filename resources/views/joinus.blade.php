      ...
      <div class="card" style="width: 28rem;">
        <div class="card-body">
          ...
          <form action="" class="needs-validation" novalidate>
            ...
            <div class="mb-3">
              <!-- is-invalid -->
              <input type="text" placeholder="اكتب اسمك" class="form-control" id="InputName" aria-describedby="validationServerNameFeedback" required>
            ...
            <div class="mb-3">
              <!-- is-invalid -->
              <input type="tel" pattern="05[0-9]{8}" placeholder="05XXXXXXXX" class="form-control" id="InputPhone" aria-describedby="validationServerPhoneFeedback" required>
            ...
            <div class="mb-3">
              <!-- is-invalid -->
              <input type="email" placeholder="email@domain.com" class="form-control" id="InputEmail" aria-describedby="validationServerEmailFeedback" required>
            ...
            <div class="mb-3">
              <!-- is-invalid -->
              <input type="text" pattern="[0-9]*" maxlength="2" placeholder="أدخل عمرك" class="form-control" id="InputAge" aria-describedby="validationServerAgeFeedback" required>
            ...
            <div class="mb-3">
              <!-- is-invalid -->
              <input type="text" placeholder="اكتب اسم الفريق" class="form-control" id="InputTeamName" aria-describedby="validationServerTeamNameFeedback">
            ...
            <div class="mb-3">
              <!-- is-invalid -->
              <select class="form-select" id="InputRole" aria-describedby="validationServerRoleFeedback">
